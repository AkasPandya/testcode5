...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'rq7LVKy_M7_Szgg',
      'isDeleted':false,
      'username':'Tyreek85',
      'email':'Everette.Vandervort26@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Tyreek85' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'PYfc4m141xtcbjS',
      'isDeleted':false,
      'username':'Imani64',
      'email':'Marielle28@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Imani64' }, userToBeInserted,  { upsert: true });
